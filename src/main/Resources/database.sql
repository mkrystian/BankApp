...
VALUES ('Tom Cruise', '78021298512', 1, 2500, 'mymail@abc.com', 'New York');

INSERT INTO DB_CLIENT (CLIENT_NAME, CLIENT_PESEL, CLIENT_GENDER, CLIENT_INITIAL_OVERDRAFT, CLIENT_EMAIL, CLIENT_CITY)
VALUES ('Elton John', '78041298513', 1, 0.0, 'nomail@rocks.com', 'Washington');

INSERT INTO DB_CLIENT (CLIENT_NAME, CLIENT_PESEL, CLIENT_GENDER, CLIENT_INITIAL_OVERDRAFT, CLIENT_EMAIL, CLIENT_CITY)
VALUES ('Carla Willis', '90121398512', 0, 4000, 'jana@abc.com', 'New Jersey');

INSERT INTO DB_CLIENT (CLIENT_NAME, CLIENT_PESEL, CLIENT_GENDER, CLIENT_INITIAL_OVERDRAFT, CLIENT_EMAIL, CLIENT_CITY)
VALUES ('Leonardo Dicaprio', '92121391212', 1, 1000, 'balti@abc.com', 'London');

INSERT INTO DB_CLIENT (CLIENT_NAME, CLIENT_PESEL, CLIENT_GENDER, CLIENT_INITIAL_OVERDRAFT, CLIENT_EMAIL, CLIENT_CITY)
VALUES ('Jena Philips', '89121398213', 0, 500, 'mailtance@abc.com', 'London');
